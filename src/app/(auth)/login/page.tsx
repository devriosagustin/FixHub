...
function LoginForm() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.error) {
        setExitoRegistro("Usuario creado exitosamente. Iniciá sesión.");
        ...
        <div className="rounded-2xl border border-border bg-card p-8 shadow-lg">
          <div className="mb-6 text-center">
            ...
            <p className="mt-2 text-sm text-text-light">
              {modoRegistro
                ? "Registrate para buscar profesionales o gestionar tu perfil."
                : "Iniciá sesión para buscar profesionales o gestionar tu perfil."}
            </p>
          </div>
          ...
          {modoRegistro ? (
            ...
            <>
              ...
              <div className="mt-3 text-center">
                <a href="/forgot-password" className="text-sm text-orange hover:underline">
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="bg-card px-2 text-text-light">O continuá con</span>
                </div>
              </div>

              <button
                onClick={() => signIn("google", { callbackUrl })}
                className="flex w-full items-center justify-center gap-3 rounded-xl border border-border bg-white px-4 py-3 font-medium text-text transition-colors hover:bg-surface"
              >
          ...
          <p className="mt-6 text-center text-xs text-text-light">
            ...
            <a href="/terminos" className="text-orange hover:underline">
              Términos y condiciones
            </a>{" "}
            y{" "}
            <a href="/privacidad" className="text-orange hover:underline">
