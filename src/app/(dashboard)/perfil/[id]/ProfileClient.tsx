...
import { Star, MapPin, Clock, Phone, Globe, Play, Award, Camera, ExternalLink, MessageCircle, PenSquare } from "lucide-react";
        ...
        <div className="space-y-6">
          ...
          <section className="rounded-xl border border-border bg-card p-6">
            ...
            <div className="space-y-2 text-sm">
              {perfil.telefono && (
                <a href={`tel:${perfil.telefono}`} className="flex items-center gap-2 text-text hover:text-orange">
                  <Phone className="h-4 w-4" /> {perfil.telefono}
                </a>
              )}
              {perfil.sitioWeb && (
